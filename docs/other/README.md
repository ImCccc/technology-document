...
回到网校系统设计上，就以视频线上点播功能的实现为例, 除了基本的系统框架外，需要考虑课程视频上传哪里？视频如何转码？视频如何加密？视频能否倍速播放？这么多问题和需求都需要自己解决吗？不用！大厂的云平台都提供了媒体服务，只需要调用媒体服务的接口，就能实现以上的功能，而这个服务就是 Pass，全称 Platform as a service 平台即服务。Pass 就是提供了一套接口来满足开发人员直接实现某些功能，再比如线上售卖课程，支付功能少不了。这样的话就可以调用第三方的支付系统来实现支付功能，第三方的支付系统也是一个 Pass 服务。
